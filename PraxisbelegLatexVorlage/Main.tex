...
%\setkomafont{pageheadfoot}{\small\scshape}
 ...
 \newtheorem{satz}{Satz}[chapter]
  %---------------------------------------------------------------------
 %Neue Befehele
 %Ersetzt die Englischen Bezeichnungen bei \autoref{}
 ...
 \renewcommand{\lstlistlistingname}{Liste über Quellcodes}% List of Listings -> List of Algorithms
 %---------------------------------------------------------------------
 %Sprachen definieren
 ...
 \lstset{language=[Sharp]C, %Standardsprach ist C#
 	showspaces=false,
 	showtabs=false,
 	breaklines=true,
...
\begin{document}
	\include{Metadaten} 
	\include{Titelseite}
	\include{00Verzeichnisse}
	\include{01ErsteKapitel}
